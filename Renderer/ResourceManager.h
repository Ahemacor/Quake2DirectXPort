...
public:
    ...
    void UpdateSRVBuffer(ID3D12Resource* imageResource, const void* pImageData, const std::size_t width, const std::size_t height, const std::size_t texelSize = 4, const D3D12_RESOURCE_STATES origState = D3D12_RESOURCE_STATE_COPY_DEST);
