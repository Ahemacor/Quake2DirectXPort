...
public:
    ...
    void UpdateVertexBuffer(ResourceManager::Resource::Id resourceId, const void* pVertexData, const std::size_t numOfVertices, const std::size_t firstVertex, const std::size_t vertexSize);
