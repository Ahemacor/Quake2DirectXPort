...
public:
    ...
    ResourceManager::Resource::Id CreateTextureBuffer(D3D12_RESOURCE_STATES resState, int numOfElements, int elementSize, const void* pSrcData);
    ...
    void UpdateTextureBuffer(D3D12_RESOURCE_STATES resState, ResourceManager::Resource::Id resourceId, const void* pSrcData, int numOfElements, int elementSize);
